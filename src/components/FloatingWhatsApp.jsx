...
function FloatingWhatsApp({ phoneNumber, accountName }) {
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <motion.button
              className="w-full bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg font-medium flex items-center justify-center"
